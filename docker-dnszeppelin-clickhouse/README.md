...
You will need to add the datasource manually using the hostname `clickhouse`, create the tables and upload the file `docker/grafana/panel.json` to grafana when creating a new panel.
